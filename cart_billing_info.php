...
<table width="600" border="0">
	...
	<tr>
		...
		<td align=left>
			<select id=creditCardType name=creditCardType onChange="javascript:generateCC(); return false;">
	...
	<tr>
		...
		<td>
          ...
          <input type="submit" value="Submit" class="btn btn-success uppercase" />
          <?php
		   }
		  else
		   {
		  ?>
          <a href="/member/login/">Please login first to submit your order</a>
          <?php
		   }
		  ?>
         </td>
