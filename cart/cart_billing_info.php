...
<table>
     ...
     <tr>
        ...
        <td>
            <input name="adress1" value="<?=$_REQUEST['adress1']?>" placeholder="Please enter your address" type="text"   tabindex="7" required><br>
  ...
  <tr>
      ...
      <td>
          ...
          <?php
		   ...
		   {
		  ?>
          <a href="../login/login.php">Please login first to submit your order</a>
          <?php
		   }
		  ?>
      </td>
