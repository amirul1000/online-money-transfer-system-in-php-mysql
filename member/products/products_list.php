...
<a href="index.php?cmd=edit" class="btn green"><i class="fa fa-plus-circle"></i> Add a <?=ucwords(str_replace("_"," ","products"))?></a> <br><br>
				      ...
				      <div class="table-responsive">	
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
                              ...
                              <td><?=$arr[$i]['product_details']?></td>
                              <td><?=$arr[$i]['size']?></td>
                              <td><?=$arr[$i]['weight']?></td>
                              <td><?=$arr[$i]['color']?></td>
                              <td><?=$arr[$i]['company_name']?></td>
                              <td><?=$arr[$i]['agreement_year']?></td>
                              <td><?=$arr[$i]['made_in']?></td>
                              <td><?=$arr[$i]['shipping_desc']?></td>
                              <td><?=$arr[$i]['delivery_desc']?></td>
                              <td><?=$arr[$i]['payment_desc']?></td>
                              <td><?=$arr[$i]['return_desc']?></td>
                              <td><img src="../../<?=$arr[$i]['file_image1']?>" style="width:100px;"></td>
                              <td><img src="../../<?=$arr[$i]['file_image2']?>" style="width:100px;"></td>
                              <td><?=$arr[$i]['product_type']?></td>
