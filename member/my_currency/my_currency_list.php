<?php
 include("../template/header.php");
	...
	$info["fields"] = array("my_currency.*"); 
	$info["where"]   = "1   $whrstr";
	$arr2 =  $db->select($info);
    if(count($arr2)==0)
	{
?>
<a href="index.php?cmd=edit" class="btn green"><i class="fa fa-plus-circle"></i> Add a <?=ucwords(str_replace("_"," ","my_currency"))?></a> <br><br>
<?php
   }
?>
 <div class="portlet box blue">
           <div class="portlet-title">
                <div class="caption"><i class="fa fa-globe"></i><b><?=ucwords(str_replace("_"," ","my_currency"))?></b>
                </div>
                <div class="tools">
					         ...
					         <div class="table-responsive">	
				                <table align="right">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("my_currency");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_my_currency" >
