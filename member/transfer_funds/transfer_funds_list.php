...
<a href="index.php?cmd=edit" class="btn red"><i class="fa fa-plus-circle"></i><?=ucwords(str_replace("_"," ","transfer_funds"))?></a> <br><br>
					         ...
					         <div class="table-responsive">	
				                <table align="right">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("transfer_funds");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_transfer_funds" >
				   ...
				   <td> 
				      ...
				      <div class="table-responsive">	
						 ...
						 <?php
							   ...
							   $whrstr .= " AND ( from_users_id='".$_SESSION['users_id']."'  OR to_users_id='".$_SESSION['users_id']."')";  
								...
								$info["fields"] = array("transfer_funds.*"); 
