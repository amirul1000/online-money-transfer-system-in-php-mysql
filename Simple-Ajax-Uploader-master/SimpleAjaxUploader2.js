...
ss.SimpleUpload2 = function( options ) {
    "use strict";
...
ss.extendObj( ss.SimpleUpload2.prototype, {
...
if ( XhrOk ) {
    ss.extendObj( ss.SimpleUpload2.prototype, ss.XhrUpload );

} else {
    ss.extendObj( ss.SimpleUpload2.prototype, ss.IframeUpload );
}

ss.extendObj( ss.SimpleUpload2.prototype, ss.DragAndDrop );
