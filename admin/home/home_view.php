...
<!-- BEGIN HEAD --><head>
<meta charset="utf-8"/>
<title>Sovereign Money Admin</title>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat purple-plum">
						...
						<div class="details">
							<div class="number">
								 <?php
								    echo get_balance($db,$_SESSION['selected_users_id']);
								 ?>
							</div>
							<div class="desc">
								Total Balance
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat green-haze">
						...
						<div class="details">
							<div class="number">
								 <?php
								    echo get_transactions_credit($db,$_SESSION['selected_users_id']);
								 ?>
							</div>
							<div class="desc">
								Total Credited
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat purple-plum">
						...
						<div class="details">
							<div class="number">
								 <?php
								    echo get_transactions_debit($db,$_SESSION['selected_users_id']);
								 ?>
							</div>
							<div class="desc">
								Total Debited
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat green-haze">
						...
						<div class="details">
							<div class="number">
								 <?php
								    echo get_total_deposits($db,$_SESSION['selected_users_id']);
								 ?>
							</div>
							<div class="desc">
								Total Deposited
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat purple-plum">
						...
						<div class="details">
							<div class="number">
								 <?php
								    echo get_transfer_funds($db,$_SESSION['selected_users_id']);
								 ?>
							</div>
							<div class="desc">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat blue-madison">
						...
						<div class="details">
							<div class="number">
								 <?php
								    echo get_total_loans($db,$_SESSION['selected_users_id']);
								 ?>
							</div>
							<div class="desc">
								Total Loans
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat green-haze">
                        ...
                        <div class="details">
                            <div class="number">
                                 <?php
                                    echo get_total_credited_loans($db,$_SESSION['selected_users_id']);
                                 ?>
                            </div>
                            <div class="desc">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat purple-plum">
                        ...
                        <div class="details">
                            <div class="number">
                                 <?php
                                    echo get_total_debitted_loans($db,$_SESSION['selected_users_id']);
                                 ?>
                            </div>
                            <div class="desc">
                                Total Debited Loans
