<?php
 ...
 include("tinymce.php");
?>
<script language="javascript" src="privacy_policy.js"></script>
	                ...
	                <table class="table">
							 <tr>
							  <td>  
								 ...
								 <form name="frm_privacy_policy" method="post"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
								  <div class="portlet-body">
						         <div class="table-responsive">	
					                <table class="table">
										 <tr>
