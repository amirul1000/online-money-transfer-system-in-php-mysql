	   ...
	   <div class="portlet-body">
		         <div class="table-responsive">	
	                <table class="table">
						 ...
						 <td>Cat Name</td>
						 <td>
						    <input type="text" name="cat_name" id="cat_name"  value="<?=$cat_name?>" class="form-control-static">
						 </td>
				     </tr><tr>
						 <td>Order No</td>
						 <td>
						    <input type="text" name="order_no" id="order_no"  value="<?=$order_no?>" class="form-control-static">
						 </td>
				     </tr>
										 <tr> 
											 <td align="right"></td>
