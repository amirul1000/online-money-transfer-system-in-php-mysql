...
?>
<script language="javascript" src="popular_products.js"></script>
	                ...
	                <table class="table">
							 <tr>
							  <td>  
								 ...
								 <form name="frm_popular_products" method="post"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
								  <div class="portlet-body">
						         <div class="table-responsive">	
					                <table class="table">
										 <tr>
...
<select  name="products_id" id="products_id"   class="form-control-static">
	...
	?> 
		           		 ...
		           		 <td>Status</td>
				   		 <td><?php
	$enumpopular_products = getEnumFieldValues('popular_products','status');
?>
<select  name="status" id="status"   class="form-control-static">
<?php
   foreach($enumpopular_products as $key=>$value)
   { 
?>
