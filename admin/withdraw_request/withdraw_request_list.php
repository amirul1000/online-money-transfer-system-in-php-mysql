...
<!--<a href="index.php?cmd=edit" class="btn green"><i class="fa fa-plus-circle"></i> Add a <?=ucwords(str_replace("_"," ","withdraw_request"))?></a> <br><br>-->
 <div class="portlet box blue">
           <div class="portlet-title">
                <div class="caption"><i class="fa fa-globe"></i><b><?=ucwords(str_replace("_"," ","withdraw_request"))?></b>
                </div>
                <div class="tools">
					         ...
					         <div class="table-responsive">	
				                <table align="right">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("withdraw_request");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_withdraw_request" >
				   ...
				   <td> 
				      ...
				      <div class="table-responsive">	
						 ...
						 <?php
								...
								$info["fields"] = array("withdraw_request.*"); 
							...
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
                              ...
                              <td>
									<?php
                                        ...
                                        $info2['table']    = users;	
                                        $info2['fields']   = array("email");	   	   
                                        $info2['where']    =  "1 AND id='".$arr[$i]['action_by_users_id']."' LIMIT 0,1";
                                        $res2  =  $db->select($info2);
                                        echo $res2[0]['email'];	
                                    ?>
                               </td>
                              ...
                              <td> 
                                     <form action="" method="post">
                                       <?php
											$enumwithdraw_request = getEnumFieldValues('withdraw_request','status');
										?>
										...
										<?php
										   ...
										   { 
										?>
										  <option value="<?=$value?>" <?php if($value==$arr[$i]['status']){ echo "selected"; }?>><?=$value?></option>
										 <?php
										  }
										?> 
										</select>
                                        <br>
                                        <input type="text" name="coin" id="coin"  value="<?=$arr[$i]['coin']?>" class="form-control-static">
                                        <input type="hidden" name="id" value="<?=$arr[$i]['id']?>">
                                        <input type="hidden" name="users_id" value="<?=$arr[$i]['users_id']?>">
                                        <input type="hidden" name="currency_id" value="<?=$arr[$i]['currency_id']?>">
                                        <input type="hidden" name="amount" value="<?=$arr[$i]['amount']?>">
                                        <input type="hidden" name="coin_type" value="<?=$arr[$i]['coin_type']?>">
