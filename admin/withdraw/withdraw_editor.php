...
?>
<script language="javascript" src="withdraw.js"></script>
	                ...
	                <table class="table">
							 <tr>
							  <td>  
								 ...
								 <form name="frm_withdraw" method="post"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
								  <div class="portlet-body">
						         <div class="table-responsive">	
					                <table class="table">
										 <tr>
...
<select  name="currency_id" id="currency_id"   class="form-control-static">
	...
	?> 
						 ...
						 <td>
		           		 ...
		           		 <td>Coin Type</td>
				   		 <td><?php
	$enumwithdraw = getEnumFieldValues('withdraw','coin_type');
?>
<select  name="coin_type" id="coin_type"   class="form-control-static">
<?php
   foreach($enumwithdraw as $key=>$value)
   { 
?>
...
?> 
						 ...
						 <td>Coin</td>
						 <td>
						    <input type="text" name="coin" id="coin"  value="<?=$coin?>" class="form-control-static">
						 </td>
				     </tr><tr>
