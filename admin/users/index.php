<?php
	   ...
	   switch($cmd)
	   {
		  ...
		  case 'add': 
				...
				$data['is_merchant']   = $_REQUEST['is_merchant'];
				if(!empty($_REQUEST['designation_id']))
				{
					$data['designation_id']   = $_REQUEST['designation_id'];
				}
		...
		case "edit":      
		 ...
		 case "change_is_merchant":
				...
				if($status==true)
				{
					$msg = "Merchant status has been changed successfully";
				}
		         include("users_list.php");						   
				break; 
         case 'delete': 
